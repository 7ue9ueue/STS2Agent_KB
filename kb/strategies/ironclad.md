...
- Prioritize routes with rest sites/campfires; they provide key smiths and emergency rests.
- The first three hallway enemies are usually weak, so early fights are acceptable for card rewards and potions.
- Treat question marks as generally positive events, especially when HP is medium or the deck no longer needs many random card rewards.
- Avoid optional elites unless in Act 1 with strong damage or in any act with very healthy HP, strong deck readiness, and potion backup.

## Act 2 Elite Rule

- Hive elites can include [Decimillipede](../enemies/elites/decimillipede.md), a top-tier threat for Ironclad.
- If the deck lacks AoE, strong multi-target damage, or a solid block/draw engine, path away from optional Act 2 elites even at decent HP.
