...
source: https://slaythespire.wiki.gg/wiki/Slay_the_Spire_2:Dramatic_Entrance
character: Colorless
type: Attack
rarity: Uncommon
cost: 0
...
**Base**: Innate . Deal 11 damage to ALL enemies. Exhaust .

**Upgraded**: Innate . Deal 15 damage to ALL enemies. Exhaust .


## Notes

### Obtaining Dramatic Entrance

Dramatic Entrance is a Colorless card, and therefore can be obtained in the following ways:
...
- **Early Access v0.98**
    - Added Dramatic Entrance to the game.
