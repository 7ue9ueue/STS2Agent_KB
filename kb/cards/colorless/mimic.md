---
title: Mimic
source: https://slaythespire.wiki.gg/wiki/Slay_the_Spire_2:Mimic
character: Colorless
type: Skill
rarity: Rare
cost: 1
...
**Base**: Gain Block equal to the Block on another player. Exhaust .

**Upgraded**: Gain Block equal to the Block on another player.
...
Mimic is a Colorless Multiplayer card, and therefore can be obtained in the following ways:
...
- Can be obtained from Lead Paperweight and Massive Scroll.
