...
source: https://slaythespire.wiki.gg/wiki/Slay_the_Spire_2:Flash_of_Steel
character: Colorless
type: Attack
rarity: Uncommon
cost: 0
...
**Base**: Deal 5 damage. Draw 1 card.
...
### Obtaining Flash of Steel

Flash of Steel is a Colorless card, and therefore can be obtained in the following ways:
...
- **Early Access v0.98**
    - Added Flash of Steel to the game.
