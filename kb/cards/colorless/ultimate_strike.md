...
source: https://slaythespire.wiki.gg/wiki/Slay_the_Spire_2:Ultimate_Strike
character: Colorless
type: Attack
rarity: Uncommon
cost: 1
...
**Upgraded**: Deal 20 damage.


## Notes

### Obtaining Ultimate Strike

Ultimate Strike is a Colorless card, and therefore can be obtained in the following ways:
...
- **Early Access v0.98**
    - Added Ultimate Strike to the game.
