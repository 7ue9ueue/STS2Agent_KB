...
| REJECTION | Rejection | Lose 10 HP. Upgrade a card. |

## Page Transition Options

| Page ID | Option ID | Title | Effect |
|---|---|---|---|
| INITIAL | LET_IT_IN | Let It In | Heal 25 HP. Add Metamorphosis to your Deck. |
| INITIAL | REJECTION | Rejection | Lose 10 HP. Upgrade a card. |
